...
from base import definir, reconnaissance_texte, determine_type, create_automate_complementaire
from util import to_png, read
...
def langage_commentaire():
    ...
    to_png(commentaire, "langage_commentaire.png")
    print(commentaire)
    print("\n L'automate du langage de commentaire a ete sauvegardé au nom de <langage_commentaire.png> dans le dossier <png> du projet")
...
def menu_reconnaissance_expression():
    ...
    res = reconnaissance_texte(F, expression)
